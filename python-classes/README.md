...
#### Classes
A class is a blueprint or a template that defines the properties and behavior of an object. In Python
classes are defined using the `class` keyword.
#### Objects
An object is an instance of a class. It has its own set of attributes (data) and
