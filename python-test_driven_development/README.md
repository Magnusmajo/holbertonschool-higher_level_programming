...
![download](https://github.com/user-attachments/assets/4d1e3790-1b7f-460b-adbd-9d075de13ec1)
```markdown
...
1. **Write a Test**: Before writing any functional code, write a test that defines a small improvement or new functionality.
2. **Run the Test**: Run the test to ensure it fails, as the functionality hasn’t been implemented yet.
3. **Write the Code**: Write the minimal code necessary to make the test pass.
4. **Refactor**: Improve the code while ensuring all tests still pass.
5. **Repeat**: Repeat the cycle for each new functionality or improvement.
